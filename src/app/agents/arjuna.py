...
NOTE: This file is being decomposed into src/app/agents/arjuna/ package.
Constants have been extracted to arjuna/constants.py.
"""
...
async def parse_assistant_intent_async(
    message: str, context: dict, history: list, thread_id: str = None
) -> dict:
    """
    Async adapter: Parse assistant intent (delegates to ArjunaAgent).
    
    Use this version in async FastAPI routes.
